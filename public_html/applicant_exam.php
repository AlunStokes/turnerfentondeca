...
if (isset($_SESSION['exam_id'])) {
 $id_query = 'SELECT created_exams_questions.question_id, question, option_a, option_b, option_c, option_d FROM created_exams_questions LEFT JOIN questions ON questions.question_id = created_exams_questions.question_id LEFT JOIN questions_options ON questions_options.question_id = created_exams_questions.question_id WHERE exam_id = '.$_SESSION["exam_id"].'';
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <!-- Logo -->
      <a href="applicant_home.php" class="logo">
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><i class="glyphicon glyphicon-chevron-left"></i>Back to Home</span>
      </a>
